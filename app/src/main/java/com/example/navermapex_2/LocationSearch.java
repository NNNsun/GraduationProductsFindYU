...
//        }
        ...
        // 정치행정대 -> 아래에 중복
//        if (userinput.equals("정행대") || userinput.equals("정치외교") || userinput.equals("JH")
//                || userinput.equals("정치외교학과")) {
//            location[0] = 463;
//            location[1] = 241;
//            ResultActivity.titleData = "[B05]정치행정대학";
//        }
        if (userinput.equals("정문") || userinput.equals("3번출구") || userinput.equals("영남대학교정문") || userinput.equals("학교정문")) {
            location[0] = 331;
            location[1] = 116;
            ResultActivity.titleData = "영남대학교 정문";
        }
        else if (userinput.equals("후문") || userinput.equals("영남대학교후문") || userinput.equals("학교후문") || userinput.equals("영남대후문")) {
            location[0] = 430;
            location[1] = 797;
            ResultActivity.titleData = "영남대학교 후문";
        }
        //A02
            ...
            location[0] = 380;
            location[1] = 80;
            ResultActivity.titleData = "[A02]국제교류센터";
        }
        //A04
        else if (userinput.equals("박물관")) {
            location[0] = 455;
            location[1] = 106;
            ResultActivity.titleData = "[A04]박물관";
        }
        //A05
        else if (userinput.equals("학생지원센터") || userinput.equals("학생지원") || userinput.equals("상담센터") || userinput.equals("취업지원센터") || userinput.equals("경력개발센터") || userinput.equals("건강관리센터")) {
            location[0] = 456;
            location[1] = 161;
            ResultActivity.titleData = "[A04]학생지원센터";
        }
        //A06
            ...
            location[0] = 515;
            location[1] = 173;
            ResultActivity.titleData = "[A06]디자인미술대학 디자인관";
        ...
        //A07
            ...
            location[0] = 542;
            location[1] = 197;
            ResultActivity.titleData = "[A07]디자인미술대학 미술관";
        }
        //A08
            ...
            location[0] = 551;
            location[1] = 211;
            ResultActivity.titleData = "[A08]사범대학";
        }
        //A10
            ...
            location[0] = 691;
            location[1] = 183;
            ResultActivity.titleData = "[A10]음악대학";
        }
        //A11
        ...
        //B01
            ...
            location[0] = 400;
            location[1] = 228;
            ResultActivity.titleData = "[B01]노천강당";
        }
        //B02
            ...
            location[0] = 421;
            location[1] = 299;
            ResultActivity.titleData = "[B02]상경관";
        }
        //B03
            ...
            location[0] = 551;
            location[1] = 354;
            ResultActivity.titleData = "[B03]인문관";
        }
        //B04 중복되는 부분
        ...
        //B06
            ...
            location[0] = 474;
            location[1] = 219;
            ResultActivity.titleData = "[B06]학생회관";
        }
        //B07
        ...
        //C02
            ...
            location[0] = 627;
            location[1] = 353;
            ResultActivity.titleData = "[C02]외국어교육원";
        }
        //C03
            ...
            location[0] = 629;
            location[1] = 318;
            ResultActivity.titleData = "[C03]종합강의동";
        }
        //C04
            ...
            location[0] = 629;
            location[1] = 265;
            ResultActivity.titleData = "[C04]인문계식당";
        }
        //C21
        ...
        //E02
            ...
            location[0] = 325;
            location[1] = 320;
            ResultActivity.titleData = "[E02]천마아트센터";
        }
        //E05
        ...
        //E21
            ...
            location[0] = 369;
            location[1] = 393;
            ResultActivity.titleData = "[E21]IT관";
        }
        //E22
            ...
            location[0] = 367;
            location[1] = 427;
            ResultActivity.titleData = "[E22]전기관";
        }
        //E22
        ...
        //E28
            ...
            location[0] = 352;
            location[1] = 590;
            ResultActivity.titleData = "[E28]소재관";
        }
        //E29
            ...
            location[0] = 360;
            location[1] = 619;
            ResultActivity.titleData = "[E29]기계관";
        }
        //F03
        ...
        //F07
            ...
            location[0] = 412;
            location[1] = 488;
            ResultActivity.titleData = "[F07]건설관";
        }

        //F21
        else if (userinput.equals("제1과학관") || userinput.equals("이과대학") || userinput.equals("이과대") || userinput.equals("제1과학")|| userinput.equals("수학과")|| userinput.equals("통계학과")|| userinput.equals("물리학과")|| userinput.equals("수학")|| userinput.equals("통계")|| userinput.equals("물리")|| userinput.equals("화학생화학부")|| userinput.equals("화학전공")|| userinput.equals("자연과학대학행정실")|| userinput.equals("자연과학대학")|| userinput.equals("자과대")|| userinput.equals("수학과사무실")|| userinput.equals("통계학과사무실")|| userinput.equals("물리학과사무실")|| userinput.equals("화학생화학과사무실")|| userinput.equals("생명과학과사무실")) {
            location[0] = 538;
            location[1] = 424;
            ResultActivity.titleData = "[F21]제1과학관";
        }
        //F22
        else if (userinput.equals("제2과학관") || userinput.equals("제2과학") || userinput.equals("생명과학과") || userinput.equals("생명과학")) {
            location[0] = 527;
            location[1] = 459;
            ResultActivity.titleData = "[F22]제2과학관";
        }
        //F23
        else if (userinput.equals("제3과학관") || userinput.equals("제3과학") || userinput.equals("생화학전공") || userinput.equals("생화학")) {
            location[0] = 497;
            location[1] = 458;
            ResultActivity.titleData = "[F23]제3과학관";
        }
        //F24
        ...
        //G13
        else if(userinput.equals("로봇관") || userinput.equals("로봇")) {
            location[0] = 450;
            location[1] = 663;
            ResultActivity.titleData = "[G13]로봇관";
        }
        //G16
        else if(userinput.equals("자동차관") || userinput.equals("자동차") || userinput.equals("자동차공학")) {
            location[0] = 383;
            location[1] = 687;
            ResultActivity.titleData = "[G16]자동차관";
        }
        else if(userinput.equals("민속촌") || userinput.equals("민속") || userinput.equals("영남대민속촌") || userinput.equals("영남대민속")) {
            location[0] = 690;
            location[1] = 510;
            ResultActivity.titleData = "민속촌";
        }
        else if(userinput.equals("경북글로벌게임센터") || userinput.equals("경북게임센터") || userinput.equals("게임센터") || userinput.equals("게임") || userinput.equals("경북글로벌게임") || userinput.equals("글로벌벤쳐동")) {
            location[0] = 414;
            location[1] = 730;
            ResultActivity.titleData = "경북글로벌게임센터";
        }
        else if(userinput.equals("경북테크노파크") || userinput.equals("경북양성평등센터") || userinput.equals("중소벤처기업진흥공단경북남부지부")) {
            location[0] = 445;
            location[1] = 724;
            ResultActivity.titleData = "경북테크노파크";
        }
        //조건에 걸리지 않는 것
        else {
            location[0] = 0;
