...
public class RoadActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mainactivity.check_src == false) {
            ...
            GpsToGrid gtg = new GpsToGrid(gps_longitude, gps_latitude);
            gtg.transformGps(); //시작좌표 설정하는 부분
        ...
        else if(mainactivity.check_src == true){
        ...
        dst_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String src_address = String.valueOf(src_search.getText());
                intent.putExtra("src_address",src_address);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE:
                ...
                src_userinput = data.getExtras().getString("src_userInput");
                src_search.setText(src_userinput);

                System.out.println("~~~~~~~~~~~~~");
                System.out.println(src_userinput);
                break;
        }
    }
    ...
    public void onMapReady (@NonNull NaverMap naverMap) {
        ...
        if(mainactivity.check_toast == 1){
            Toast.makeText(RoadActivity.this, "영남대 밖에서 검색중입니다.", Toast.LENGTH_SHORT).show();
            Toast.makeText(RoadActivity.this, "가장 가까운 출입문으로\n출발지를 설정합니다.", Toast.LENGTH_SHORT).show();
        }
//        //상경대 이미지추가
