...
public class ResultActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private ImageButton prev_btn, exit_btn, dst_btn, src_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        src_btn = findViewById(R.id.src_button);
...
//        }
        ...
        if(connect.getStringExtra("new_user_input") != null) {
            ...
            user_input = new_user_input.replaceAll("\\s", ""); //새로검색되도 올바른작동
...
//            place = jc.strToArray();
        ...
        dst_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("dst_userInput", user_input);
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        });
        ...
        src_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //경로탐색 결과화면으로 이동
                //검색한 장소의 좌표 넘겨야함.(place 배열 전달할 것)
                mainactivity.check_src = true;
                mainactivity.src_input = user_input;
                Intent intent = new Intent(ResultActivity.this, RoadActivity.class);
                System.out.println("체크체크체크욤");
                System.out.println(mainactivity.check_src);
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        try {
                            if (pendingDynamicLinkData != null) {
                                ...
                                cord_deeplink[1] = tmp;
                                title.setText("위치공유");
                                comment.setText("친구가 어디있는지 찾아보아요!");
                                src_btn.setVisibility(View.GONE);
                            }
                        }
                        catch (Exception e) {
                            e.printStackTrace();
